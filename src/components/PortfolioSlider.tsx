    ...
    >
      <div className="max-w-full py-0 justify-center text-center">
        <div className="flex mb-6">
          ...
          <div className="relative w-full sm:w-dvh h-72 mb-10 overflow-hidden">
            <div className="flex flex-nowrap h-full animate-projects-slider">
              {itemsLong.map((project, i) => (
                <div key={`${project.id}-${i}`}
                  className="w-80 sm:w-96 lg:w-[30rem] h-full flex flex-col items-center justify-center px-2 shrink-0 hover:scale-[1.02] transition-transform duration-300 z-100"
                >
                  <div className="bg-cyan-100 bg-opacity-95 rounded-2xl shadow-md p-1 sm:p-2 w-full max-w-xl border border-gray-200 h-full flex">
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 h-full w-full pt-1 overflow-y-auto">
                      ...
                      <div className="flex-1 flex flex-col min-h-35 h-full">
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <span className="font-semibold text-gray-900 text-sm sm:text-lg block leading-snug">
                              {project.title}
                            </span>
                            <div className="sm:my-3 text-xs text-gray-500 font-medium mt-1">
                          ...
                          <div className="flex gap-1 shrink-0">
                            <a
                              ...
                              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-2 py-1 sm:px-3 sm:py-2 rounded-md text-xs sm:text-sm whitespace-nowrap"
                            >
                              Ver Site
                            </a>
                          </div>
                        ...
                        <p className="hidden lg:block text-gray-700 text-sm italic mb-2 mt-3">
                          {project.description}
                        </p>
